...
Every retrieval here is real HTTP over loopback (`tests/localise/localisation_fixtures.py` says why that
...
from tests.localise.localisation_fixtures import (
    PROFILE,
    Response,
...
from tests.support.image_fixtures import baseline_jpeg
