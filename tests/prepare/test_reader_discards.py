...
from tests.prepare.repair_fixtures import RepairInputs, inspected, repaired_document
from tests.support.article_fixtures import filler
from tests.support.article_server import served
from tests.support.markdown_fixtures import native_ast, write_markdown
...
def test_the_human_output_carries_the_same_qualification(tmp_path: Path) -> None:
    ...
    assert "Text Preservation: not claimed (the source reader discarded content" in (result.stdout)
